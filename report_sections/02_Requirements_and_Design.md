...
Testing is governed by seven documents, submitted alongside this report. Detailed procedures, pass criteria and signed results are recorded in those documents rather than reproduced here, keeping this report focused on design, evidence and analysis.
...
5	Functional Prototype Test Plan	First power-on, dashboard connectivity, sensor response, end-to-end dispense, physical use, power resilience, soak test	7	Alan / Blaise
6	System Integration and Validation Test Plan	Cross-subsystem integration verification (Part A) and requirement validation (Part B)	2 parts	Alan / Blaise
7	Week 12 Development Verification Record	Networking, notifications, controller communication, dispensing logic, LCD, dashboard, motor control, diagnostics	(none)	Alan / Blaise

4.6 System-Level Test Coverage
The system-level plan (document 6 above) is organised in two parts, reflecting the distinction between building the system correctly and building the correct system.
