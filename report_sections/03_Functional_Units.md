...
The earlier apparent GPIO 6 conflict is resolved: GPIO 6 is Stepper 2's AIN1 line and nothing else. The Hall-effect sensors are not on the RP2350 at all; they connect to the ESP32-S3 (Table 5.6, Section 5.5.2).
...
Table 5.6: ESP32-S3 GPIO assignment
Function	GPIO	Direction	Notes
...
Table 5.9: /api/status response fields
Field	Description
